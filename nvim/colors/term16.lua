...
local groups = {
  Comment = { ctermfg = "DarkGray" },
  -- ColorColumn = { bg = c.black }, -- used for the columns set with 'colorcolumn'
  Conceal = { ctermfg = "DarkGray" }, -- placeholder characters substituted for concealed text (see 'conceallevel')
  ...
  Folded = { ctermfg = "DarkGray", bold = true }, -- line used for closed folds
  ...
  LineNr = { ctermfg = "DarkGray" }, -- Line number for ":number" and ":#" commands, and when 'number' or 'relativenumber' option is set.
  ...
  Constant = { ctermfg = "Yellow" }, -- (preferred) any constant
  -- Debug = { fg = c.orange }, --    debugging statements
  -- Delimiter = "Special", --  character that needs attention
  -- Error = { fg = c.error }, -- (preferred) any erroneous construct
  Function = { ctermfg = "Blue" }, -- function name (also: methods for classes)
  Identifier = { ctermfg = "DarkRed" }, -- (preferred) any variable name
  -- Italic = { italic = true, fg = c.fg }, -- (preferred) any italic text
  Keyword = { ctermfg = "Magenta" }, --  any other keyword
  Operator = { ctermfg = "Cyan" }, -- "sizeof", "+", "*", etc.
  -- PreProc = { fg = c.cyan }, -- (preferred) generic Preprocessor
  -- Special = { ctermfg = "Blue" }, -- (preferred) any special symbol
  Statement = { ctermfg = "Magenta" }, -- (preferred) any statement
  -- String = { fg = c.green }, --   a string constant: "this is a string"
  -- Todo = { bg = c.yellow, fg = c.bg }, -- (preferred) anything that needs extra attention; mostly the keywords TODO FIXME and XXX
  Type = { ctermfg = "DarkYellow" }, -- (preferred) int, long, char, etc.
